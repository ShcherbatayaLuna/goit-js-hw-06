...
// Створи функцію createBoxes(amount), яка
// приймає один параметр - число. Функція створює
// стільки < div >, скільки вказано в amount і додає
// їх у div#boxes.
...
// у форматі HEX. Використовуй готову функцію
